...
<td align="center">
  <a href="https://grafana.coventix.be/public-dashboards/9c317975a88a4d93ac518a766fde8ec9">
    <img src="./img/grafana-preview.jpg" width="400px" alt="Grafana"/>
    <br/>📊 Live Stats
  </a>
</td>
<td align="center">
  <a href="https://uptime.coventix.be/status/acacia">
    <img src="./img/uptime-preview.jpg" width="400px" alt="Uptime"/>
    <br/>⚡ Uptime Monitor
  </a>
</td>
</tr>
...
![diagram](./img/network-diagram.jpg)
*The whole shebang*
...
**High Availability** — The hybrid lab runs 2 nginx containers on different nodes with a HAProxy load balancer on a third. If a node dies, services keep running.
...
**Self-Hosted Everything** — AdGuard Home for DNS, Advanced monitoring (Grafana, Prometheus, Loki, Uptimekuma, MKTXP, etc.), Caddy for reverse proxy, Code-server for editing configs from anywhere, Jellyfin for streaming, ...
